        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {[
              ...
              { name: "Videography", icon: <VideoIcon className="w-16 h-16" />, desc: "Cinematic video production capturing every moment of your special event" },
              { name: "Social Media", icon: <SocialIcon className="w-16 h-16" />, desc: "Strategic promotion to amplify your event's reach and engagement online" },
              ...
              <div key={index} className="group bg-black p-8 rounded-lg hover:bg-white transition-colors w-80 text-center">
