const Footer = () => {
  return (
    <footer className="bg-evo-gray border-t border-gray-700">
      {/* Main Footer */}
      <div className="max-w-4xl mx-auto px-6 py-8 text-center">
        {/* Contact */}
        <div className="mb-8">
          <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Contact</h4>
          <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-8 text-sm">
            <div className="text-center">
              <span className="text-white/40 block text-xs uppercase tracking-wider mb-1">Email</span>
              <a href="mailto:bookings@theclanofevolution.com" className="text-white hover:text-red-600 transition-colors">
                bookings@theclanofevolution.com
              </a>
            </div>
            <div className="text-center">
              <span className="text-white/40 block text-xs uppercase tracking-wider mb-1">Phone</span>
              <a href="tel:5551230000" className="text-white hover:text-red-600 transition-colors">
                (555) 123-EVOLUTION
              </a>
            </div>
            <div className="text-center">
          ...
          <div className="flex justify-center gap-3">
            {[
              ...
              <a
                ...
                className="w-10 h-10 bg-white/5 flex items-center justify-center text-red-600 hover:bg-red-600 hover:text-white transition-all"
                title={social.name}
              >
                {social.icon}
              </a>
      ...
      <div className="border-t border-white/10">
        <div className="container-max py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/30 text-sm">
            © 2024 The Clan of Evolution. All rights reserved.
          </p>
          <div className="flex gap-6 text-sm">
            <a href="/admin" className="text-white/30 hover:text-evo-red transition-colors">Admin</a>
